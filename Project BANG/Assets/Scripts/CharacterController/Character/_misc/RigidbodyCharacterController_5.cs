...
//	public abstract class RigidbodyCharacterController_5 : MonoBehaviour
//	{
...
//				m_animator.deltaRotation.ToAngleAxis(out float m_deltaAngle, out Vector3 axis);
//				m_deltaAngle = (m_deltaAngle * m_rootMotionSpeedMultiplier * Mathf.Deg2Rad) / m_deltaTime;
//				m_rootMotionRotation = Quaternion.AngleAxis(m_deltaAngle, axis);
...
//					m_moveAngle = m_transform.AngleFromForward(m_inputDirection);
...
//			m_moveDirection.x += direction.x * m_acceleration.x;
//			m_moveDirection.z += direction.z * m_acceleration.z;
//			m_moveDirection.y = 0;
...
//			if (m_grounded)
//			{
//				Vector3 drag = velocity * MathUtil.SmoothStop3(m_motorDamping * m_deltaTime);
//				if (m_inputDirection.sqrMagnitude > 0)
...
//				velocity.x += m_inputDirection.x * m_acceleration.x;
//				velocity.y += m_inputDirection.y * m_acceleration.y;
//				velocity.z += m_inputDirection.z * m_acceleration.z;
