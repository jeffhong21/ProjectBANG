...
namespace ActorSkins
{
    ...
    public class ActorSkinComponent : MonoBehaviour
    {
        ...
        private readonly string materialTextureSlot = "_Diffuse";
		...
		private void Start()
		{
            if (meshRenderer == null || skin == null) return;
            meshRenderer.material.SetTexture("_Diffuse", skin.GetRandmTexture());
		}
		...
		public void LoadActorSkin()
        {
            ...
            if(randomSkin){
                ...
                //meshRenderer.material.SetTexture("_Diffuse", skin.GetRandmTexture());
                //meshRenderer.sharedMaterial.mainTexture = skin.GetRandmTexture();
            }
