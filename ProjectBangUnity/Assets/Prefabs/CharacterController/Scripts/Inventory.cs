namespace CharacterController
{
    ...
    public class Inventory : MonoBehaviour
    {
        ...
        public class ItemAmount
        {
            ...
            public bool Equip{
                get{
                    if (m_ItemType.GetType() == typeof(ConsumableItemType)) 
                        m_Equip = false;
                    return m_Equip;
                }
            }
        ...
        private ItemSlot m_RightHandSlot;
        private ItemSlot m_LeftHandSlot;
        ...
        public void PickupItem(ItemType itemType, int amount, bool equip, bool immediateActivation)
        {
            if(!m_Inventory.ContainsKey(itemType))
            {
                ...
                if(itemType.Stackable || itemType is ConsumableItemType){
        ...
        public void UseItem(ItemType itemType, int amount)
        {
            ...
            if(item != null && item.TryUse()){
                ...
                //  Play animation.
                if(itemType.GetType() == typeof(PrimaryItemType)){
                    var p = (PrimaryItemType)itemType;
        ...
        public void EquipItem(ItemType itemType)
        {
            if (m_Inventory.ContainsKey(itemType)){
                if (itemType.GetType() == typeof(PrimaryItemType)){
                    m_EquippedItemType = itemType as PrimaryItemType;
                    //Debug.Log(m_Inventory[m_EquippedItemType].Item);
                    //m_Inventory[m_EquippedItemType].Item.SetActive(true);
                }
            }
            //int itemIndex = Array.IndexOf(m_CurrentInventory, typeof(PrimaryItemType));
        ...
        public void EquipItem(int itemIndex)
        {
            ...
            if (m_CurrentInventory[itemIndex].GetType() == typeof(PrimaryItemType)){
                m_EquippedItemType = m_CurrentInventory[itemIndex].ItemType as PrimaryItemType;
            }
        }
