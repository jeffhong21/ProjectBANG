namespace AtlasAI.Visualization
{
    ...
    public abstract class ActionWithOptionsVisualizerComponent<T, TOption> : CustomGizmoGUIVisualizerComponent<T, List<OptionScorer<TOption>>> where T : ActionWithOptions<TOption>
    {
        ...
        // Fields
        //
        private List<OptionScorer<TOption>> _scoredBuffer;
        ...
        {
            if(_scoredBuffer == null) _scoredBuffer = new List<OptionScorer<TOption>>();
            //Debug.Log("Calling constructor for ActionWithOptionsVisualizerComponent");
        }
