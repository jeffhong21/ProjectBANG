...
namespace KinematicCharacterController.Examples
{
    ...
    public class ExampleCharacterController : MonoBehaviour, ICharacterController
    {
        ...
        public float AirAccelerationBias = 0f;
                ...
                case CharacterState.Default:
                    {
                        ...
                        {
                            int nbHits = Motor.CharacterCollisionsRaycast(Motor.TransientPosition + (Motor.TransientRotation * Motor.Capsule.center), -Motor.Transform.up, Motor.Capsule.height, out RaycastHit closestHit, _probedHits);
                            if (nbHits > 0)
                            {
                                float groundReorientSharpness = 10f;
                                Vector3 smoothedNormal = Vector3.Slerp(Motor.CharacterUp, closestHit.normal, 1 - Mathf.Exp(-groundReorientSharpness * deltaTime));
