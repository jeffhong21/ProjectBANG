    ...
    public class CharacterIK : MonoBehaviour
    {
        ...
        private void OnAim(bool aim)
        {
            ...
            if(aim){
                ...
                m_TargetHandWeight = m_CurrentItem == null ? 0 : 1;
            }
            else{
                m_TargetLookAtWeight = 0;
                m_TargetHandWeight = 0;
            }
        }
        ...
        protected virtual void LookAtTarget()
        {
            ...
            m_Animator.SetLookAtWeight(m_LookAtAimBodyWeight, m_LookAtBodyWeight, m_LookAtHeadWeight, m_LookAtEyesWeight, m_LookAtClampWeight);
        ...
        protected virtual void RotateDominantHand()
        {
            ...
            m_Animator.SetIKRotationWeight(AvatarIKGoal.RightHand, m_HandIKWeight);
        ...
        protected virtual void PositionHands()
        {
            ...
            //Vector3 targetPosition = m_RightHandTarget.position + m_RightHandTarget.rotation * m_HandIKOffset;
            //targetPosition += m_RightHand.position + m_RightHand.rotation * m_HandIKOffset;

            m_Animator.SetIKPositionWeight(AvatarIKGoal.RightHand, m_HandIKWeight);
