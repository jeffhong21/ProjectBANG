namespace CharacterController
{
    ...
    {
        private readonly string BaseLayerName = "Base Layer";
        private readonly string UpperBodyLayerName = "Upper Body Layer";
        private readonly string AdditiveLayerName = "Additive Layer";
        private readonly string FullBodyLayer = "Full Body Layer";
        ...
        {
            Debug.LogFormat("Executing event \"{0}\"", eventName);
        }
