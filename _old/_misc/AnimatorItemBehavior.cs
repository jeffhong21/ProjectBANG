namespace CharacterController
{
    ...
    public class AnimatorItemBehavior : StateMachineBehaviour
    {
        ...
        public override void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
        {
            ...
            Debug.LogFormat("On State <color=blue> {0} </color> | Length: {1} | NormalizedTime: {2}", "Enter", stateInfo.length, stateInfo.normalizedTime);
        ...
        public override void OnStateMachineEnter(Animator animator, int stateMachinePathHash)
        {
            ...
            Debug.LogFormat("On StateMachine <color=blue> {0} </color> | FullHashPath: {1}", "Enter", stateMachinePathHash);
        ...
        public override void OnStateMachineExit(Animator animator, int stateMachinePathHash)
        {
            ...
            Debug.LogFormat("On StateMachine <color=red> {0} </color> | FullHashPath: {1}", "Exit", stateMachinePathHash);
