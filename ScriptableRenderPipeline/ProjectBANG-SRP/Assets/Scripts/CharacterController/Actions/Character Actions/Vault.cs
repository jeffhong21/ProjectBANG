namespace CharacterController
{
    ...
    public class Vault : CharacterAction
    {
        ...
        protected override void ActionStarted()
        {
            ...
            //startDistance = Vector3.Distance(m_StartPosition, m_MoveToVaultDistanceHit.point);
            //Debug.LogFormat("Start Distance {0}", startDistance);
        }
        ...
        public override bool UpdateMovement()
        {
            ...
            m_CapsuleCollider.height = Mathf.Lerp(m_CapsuleCollider.height, m_HeightDifference >= 0.25f ? m_ColliderHeight * 0.45f : m_ColliderHeight, (Time.time - m_StartTime) / 3 * 1);
            m_CapsuleCollider.center = m_ColliderCenter - (m_ColliderCenter * 0.45f);
            m_VerticalVelocity = Vector3.up * (m_VaultObjectHeight + m_ColliderHeight + m_MatchTargetState.matchTargetOffset.y);
